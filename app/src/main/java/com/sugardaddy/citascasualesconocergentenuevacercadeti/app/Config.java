...
public class Config {
    ...
    static final String SERVER_APP_ID = "2jQ5ZsWF248lpjkDIPbPTy03OTIrmdl0kjOJpRud";
    static final String SERVER_CLIENT_KEY = "vJexlhnlaAZ08H4Vx9cXGYUznepZbDOetiYr5KiC";

    // Push notifications
    public static final String CHANNEL = "global";

    // Agora API
    public static final String AGORA_APP_ID = "7f87808dc1fd4d1486dfaffe95d970a6";

    // FlutterWave
    public static final String FLUTTERWAYE_PUBLISH_KEY = "FLWPUBK-b3aa7d507e54545fadbace19b569-X";
    public static final String FLUTTERWAYE_ENCRYPTION_KEY = "92a7ebb56f9584727dc313";

    // PayPal
    public static final String PAYPAL_CLIENT_ID = "AVH5uPrdpGln1H4SiJ4-44NBalxHZYG806bgGYjh8Kcr6zQuvMK6PAVognpciXERaOn4bV5s7OIyz-jZ";

    // Instagram API
    public static final String INSTAGRAM_APP_ID = "740760960067456";
    public static final String INSTAGRAM_APP_SECRET = "b87d6d5a53c35381995dc18f9fafdb19";
    public static final String INSTAGRAM_REDIRECT_URI = "http://qiluchat.jasaadwordsid.com/";

    // Google Admob
    static final String HOME_BANNER_ADS = "ca-app-pub-1856022005495340/8788617639";
    static final String REWARDED_ADS= "ca-app-pub-1856022005495340/4657800937";
    static final String NEARBY_NATIVE_ADS = "ca-app-pub-1856022005495340/4662682120";
    static final String ENCOUNTERS_NATIVE_ADS = "ca-app-pub-1856022005495340/4662682120";
